...
public class DashboardSteps extends CommonMethods {
    ...
    public void user_verify_all_the_dashboard_tabs(DataTable dataTable) {
        ...
        System.out.println(expectedTabs);// ***data coming from the feature file is available in expectedTabs***
        System.out.println(actualTabs);// ***data coming from the application is available in actualTabs***
        ...
        // .equals compare two lists together. If it is equal we get true
    }
